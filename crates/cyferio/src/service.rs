...
use crate::spec::CyferioSpec;
use crate::verifier::CyferioVerifier;
use anyhow::Error;
...
impl DaService for DaProvider {
    type Spec = CyferioSpec;
    type Config = CyferioConfig;
    type Verifier = CyferioVerifier;
    ...
    async fn send_proof(
        ...
        let blob_base64 = general_purpose::STANDARD.encode(aggregated_proof);
        println!("blob_base64: {:?}", blob_base64);
